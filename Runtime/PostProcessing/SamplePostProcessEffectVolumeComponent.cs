...
[VolumeComponentMenu("Post-processing Custom/SamplePostProcessEffect")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(SamplePostProcessEffectRendererFeature))]
...
public sealed class SamplePostProcessEffectVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public SamplePostProcessEffectVolumeComponent()
    {
        displayName = "SamplePostProcessEffect";
    }
